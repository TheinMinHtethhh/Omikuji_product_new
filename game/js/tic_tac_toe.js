...
let winningLine = null;   // ★ 追加：勝利ライン保存用

const msgtxt1 =
  '<p class="image"><img src="img/penguins.jpg" width="61" height="61"></p><p class="text">Penguins Attack!</p>';
...
[a_1, a_2, a_3, b_1, b_2, b_3, c_1, c_2, c_3].forEach(sq => {
...
function setMessage(id) {
  switch (id) {
    ...
    case "bear-turn":
      ...
      break;
    case "pen-win":
      document.getElementById("msgtext").innerHTML = msgtext3;
      break;
    case "bear-win":
      document.getElementById("msgtext").innerHTML = msgtext4;
      break;
    case "draw":
      document.getElementById("msgtext").innerHTML = msgtext5;
      break;
  }
}
